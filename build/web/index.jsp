        ...
        <div class="modal-body">
             <form action="sr_estudiantes" method="post" class="form-group">
               <label for="lbl_id" ><b>ID</b></label>
                ...
                <input type="number" name="txt_ce" id="txt_telefono" class="form-control" placeholder="Ejemplo: 5555555" required>
                <label for="lbl_ce" ><b>Correo Electronico</b></label>
                <input type="text" name="txt_ce" id="txt_ce" class="form-control" placeholder="Ejmeplo: ejemplo@gmail.com" required>
...
<script type="text/javascript">
    ...
    $('#tbl_estudiantes').on('click','tr td',function(evt){
       var target,id,id_p,codigo,nombres,apellidos,direccion,telefono,ce,nacimiento; 
       target = $(event.target);
       ...
       ce = target.parent("tr").find("td").eq(5).html();
